...
import com.kuang.util.GenerateSongUtil;
...
public class SongController {
    ...
    public ResponseEntity<InputStreamResource> downSong(@PathVariable String rid, @RequestHeader("Authorization") String token) throws IOException, SqlException, GenerateSongException {
        ...
        recordService.addRecordIgnore(record);

        String musicPath = myConfig.getDownloadSongAddress();
        if (myConfig.isGenerateSongFile()) {
            GenerateSongUtil.generateSongFile(rid);
        }
